...
{
    if((*dependencies)[MIXER_SIGNAL_1_MULTIPLIER_TEXT_BOX] != NULL)
    {
    ...
    if((*dependencies)[MIXER_SIGNAL_2_MULTIPLIER_TEXT_BOX] != NULL)
    {
    ...
    if((*dependencies)[MIXER_SIGNAL_3_MULTIPLIER_TEXT_BOX] != NULL)
    {
    ...
    if((*dependencies)[MIXER_SIGNAL_4_MULTIPLIER_TEXT_BOX] != NULL)
    {
    ...
    if((*dependencies)[MIXER_SIGNAL_5_MULTIPLIER_TEXT_BOX] != NULL)
    {
    ...
    if((*dependencies)[MIXER_SIGNAL_6_MULTIPLIER_TEXT_BOX] != NULL)
    {
    ...
    if((*dependencies)[MIXER_SIGNAL_7_MULTIPLIER_TEXT_BOX] != NULL)
    {
    ...
    if((*dependencies)[MIXER_SIGNAL_8_MULTIPLIER_TEXT_BOX] != NULL)
    {
