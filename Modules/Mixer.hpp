...
{
    MIXER_SIGNAL_1_DEPENDENCY = 0,
    MIXER_SIGNAL_1_MULTIPLIER_DEPENDENCY,
    MIXER_SIGNAL_2_DEPENDENCY,
    MIXER_SIGNAL_2_MULTIPLIER_DEPENDENCY,
    MIXER_SIGNAL_3_DEPENDENCY,
    MIXER_SIGNAL_3_MULTIPLIER_DEPENDENCY,
    MIXER_SIGNAL_4_DEPENDENCY,
    MIXER_SIGNAL_4_MULTIPLIER_DEPENDENCY,
    MIXER_SIGNAL_5_DEPENDENCY,
    MIXER_SIGNAL_5_MULTIPLIER_DEPENDENCY,
    MIXER_SIGNAL_6_DEPENDENCY,
    MIXER_SIGNAL_6_MULTIPLIER_DEPENDENCY,
    MIXER_SIGNAL_7_DEPENDENCY,
    MIXER_SIGNAL_7_MULTIPLIER_DEPENDENCY,
    MIXER_SIGNAL_8_DEPENDENCY,
    MIXER_SIGNAL_8_MULTIPLIER_DEPENDENCY,
};
